...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa un atleta según su nombre");
	...
	/**
	 * Informa al usuario el nombre del país que representa un atleta determinado.
	 */
	private void ejecutarPaisDeUnAtleta()
	{
		...
		{
			System.out.println("El atleta " + atleta + " representa al país: " + pais);
		}
	}
